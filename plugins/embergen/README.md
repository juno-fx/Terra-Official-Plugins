...
**Namespaced Plugin** — Installed into your project namespace. This plugin runs an installer Job that places EmberGen into a shared volume accessible by workstations in the project.
...
|-------|------|----------|---------|-------------|
| `version` | string | **Yes** | — | EmberGen version to install (e.g. `1.2.4`) |
| `install_volume` | shared-volume | **Yes** | — | Shared persistent volume to install EmberGen into |
| `destination` | string | No | `/embergen` | Directory path within the volume for the installation |

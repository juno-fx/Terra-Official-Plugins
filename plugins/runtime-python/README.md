...
![Runtime Python](https://github.com/juno-fx/Terra-Official-Plugins/blob/main/plugins/runtime-python/assets/icon.svg?raw=true)
...
| `build_command` | **string** · Optional · Default: `pip install -r requirements.txt`<br>Build command run in the work root, e.g. `pip install -r requirements.txt` |
| `run_command` | **string** · Required · Default: `python main.py`<br>Command that starts your application, e.g. `python main.py`, `uvicorn app:app --port 8080` |
